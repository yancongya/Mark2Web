...
1.  **Clone the repository**
    ```bash
    git clone https://github.com/yancongya/Mark2Web.git
    cd Mark2Web
    ```
...
[![Deploy to Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/yancongya/Mark2Web)
